...
function RouteComponent() {
    ...
    const [pendingValues, setPendingValues] = useState<ApplicationCreateInputType | null>(null)

    // Fetch existing deployment data
    const { data: deploymentData, isLoading, isError, error } = useQuery({
    ...
    if (isError) {
        return (
            <div className="mt-16 text-center">
                <p className="text-destructive font-semibold">Failed to load deployment data</p>
                ...
                <FieldGroup>
                    ...
                    <Field orientation="horizontal" className="flex gap-2">
                        <Button
                            ...
                            disabled={updateDeploymentMutation.isPending}
                        >
                            {updateDeploymentMutation.isPending ? "Updating..." : "Update Deployment"}
                        </Button>
                        <Button
                            variant="outline"
                            type="button"
            ...
            <AlertDialog open={isConfirmOpen} onOpenChange={setIsConfirmOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to update this deployment configuration? This action
                            will apply changes to the live cluster pods.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
